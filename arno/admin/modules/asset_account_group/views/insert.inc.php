<script>
    ...
    function check(){
        ...
        if(code_check != ""){
            ...
            return false;
        }else if(asset_account_group_code.length == 0){
    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form  id="form_target" role="form" method="post" onsubmit="return check();" action="index.php?app=asset_account_group&action=add" >
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label>รหัสกลุ่มบัญชีทรัพย์สิน / Account Group Code <font color="#F00"><b>*</b></font></label>
                                <input id="asset_account_group_code" name="asset_account_group_code" class="form-control" onchange="check_code(this)" />
                        ...
                        <div class="col-lg-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="asset_account_group_name_th" name="asset_account_group_name_th" class="form-control">
                        ...
                        <div class="col-lg-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="asset_account_group_name_en" name="asset_account_group_name_en" class="form-control">
