                    ...
                    <div class="row">
                        <div class="col-lg-3">
                            <div class="form-group">
                                ...
                                <input id="asset_department_code" name="asset_department_code" class="form-control" onchange="check_code(this)" />
                        ...
                        <div class="col-lg-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="asset_department_name_th" name="asset_department_name_th" class="form-control">
                        ...
                        <div class="col-lg-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="asset_department_name_en" name="asset_department_name_en" class="form-control">
