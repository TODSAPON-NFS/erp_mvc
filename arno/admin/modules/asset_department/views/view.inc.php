                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <div class="row">
                                <div class="col-md-8">
                                    รายการแต่ละแผนก / Department  List
                                </div>
                                <div class="col-md-4">
                                    <?php if($license_admin_page == "Medium" || $license_admin_page == "High"){ ?> 
                                        <a class="btn btn-success " style="float:right;" href="?app=asset_department&action=insert" ><i class="fa fa-plus" aria-hidden="true"></i> Add</a>
                                    <?PHP } ?>
                                </div>
                            </div>
                        </div>
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td ><?php echo $asset[$i]['asset_department_name_th']; ?></td>
                                        <td ><?php echo $asset[$i]['asset_department_name_en']; ?></td>
                                        <td style="text-align:center;">
                                        <?php if($license_admin_page == "Medium" || $license_admin_page == "High"){ ?> 
                                            <a href="?app=asset_department&action=update&id=<?php echo $asset[$i]['asset_department_id'];?>">
                                                <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                                            </a> 
                                        <?PHP }?>
                                        <?php if($license_admin_page == "High"){ ?> 
                                            <a href="?app=asset_department&action=delete&id=<?php echo $asset[$i]['asset_department_id'];?>" onclick="return confirm('You want to delete asset : <?php echo $asset[$i]['asset_department_name_th']; ?>');" style="color:red;">
