<script>
    ...
    function calculateAll(){
        ...
        $('#billing_note_net').val((total).toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") );
    }
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input id="customer_code" name="customer_code" class="form-control" value="<? echo $billing_note['customer_code'];?>" readonly>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <select id="customer_id" name="customer_id" class="form-control select" onchange="get_customer_detail()" data-live-search="true">
                                            ...
                                            ?>
                                            <option <?php if($customers[$i]['customer_id'] == $billing_note['customer_id']){?> selected <?php }?> value="<?php echo $customers[$i]['customer_id'] ?>"><?php echo $customers[$i]['customer_name_en'] ?> (<?php echo $customers[$i]['customer_name_th'] ?>)</option>
                                            <?
                                            }
                                            ?>
                                        </select>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="billing_note_date" name="billing_note_date"  class="form-control calendar" value="<?php echo $billing_note['billing_note_date'];?>" readonly/>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input id="billing_note_code" name="billing_note_code" class="form-control" value="<?php echo $billing_note['billing_note_code'];?>" >
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <select id="employee_id" name="employee_id" class="form-control select" data-live-search="true">
                                            ...
                                            ?>
                                            <option <?PHP if($billing_note['employee_id'] == $users[$i]['user_id']){?> SELECTED <?PHP }?> value="<?php echo $users[$i]['user_id'] ?>"><?php echo $users[$i]['name'] ?> (<?php echo $users[$i]['user_position_name'] ?>)</option>
                                            <?
                                            }
                                            ?>
                                        </select>
