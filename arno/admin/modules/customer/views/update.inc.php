    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form role="form" id="form_target" method="post" onsubmit="return check();" action="index.php?app=customer&action=edit&id=<?php echo $customer_id ?>" enctype="multipart/form-data" >
