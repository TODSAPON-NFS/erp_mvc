                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                    <?php 
                                    for($i=0; $i < count($customer_account); $i++){
                                    ?>
                                    <tr class="odd gradeX">
                                        <td><?php echo $i+1; ?></td>
                                        <td><?php echo $customer_account[$i]['customer_account_no']; ?></td>
                                        <td><?php echo $customer_account[$i]['customer_account_name']; ?></td>
                                        <td><?php echo $customer_account[$i]['customer_account_bank']; ?></td>
