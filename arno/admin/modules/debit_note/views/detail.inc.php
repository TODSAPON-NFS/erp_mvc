                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <p class="help-block"><?php echo $debit_note['debit_note_name'];?></p>
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label>ที่อยู่ตามใบกำภาษี / Address <font color="#F00"><b>*</b></font></label>
                                        <p class="help-block"><?php echo $debit_note['debit_note_address']; ?></p>
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label>เลขประจำตัวผู้เสียภาษี / Tax <font color="#F00"><b>*</b></font></label>
                                        <p class="help-block"><?php echo $debit_note['customer_tax'];?></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <p class="help-block"><?php echo $debit_note['debit_note_date'];?></p>
                                    </div>
                                </div>

                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label>หมายเลขใบเพิ่มหนี้ / DN code <font color="#F00"><b>*</b></font></label>
                                        <p class="help-block"><?php echo $debit_note['debit_note_code'];?></p>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <p class="help-block"><?php echo $debit_note['invoice_customer_code'];?></p>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <p class="help-block"><?php echo $debit_note['debit_note_due'];?></p>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <p class="help-block"><?php echo $debit_note['debit_note_term'];?></p>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <p class="help-block"><?php echo $debit_note['user_name'];?> <?php echo $debit_note['user_lastname'];?> (<?php echo $debit_note['user_position_name'];?>)</p>
                                    </div>
                                </div>
