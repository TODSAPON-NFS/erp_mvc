<script>
    ...
    function get_customer_detail(){
        ...
        $.post( "controllers/getCustomerByID.php", { 'customer_id': customer_id }, function( data ) {
            ...
            document.getElementById('debit_note_name').value = data.customer_name_en +' (' + data.customer_name_th +')';
...
<div class="row">
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            เพิ่มใบเพิ่มหนี้ / Add Debit Note  
            </div>
            <!-- /.panel-heading -->
            <div class="panel-body">
                <form role="form" method="post" onsubmit="return check();" action="index.php?app=debit_note&action=add" >
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="row">
                                <div class="col-lg-6">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input  id="debit_note_name" name="debit_note_name" class="form-control" value="<?php echo $customer['customer_name_en'];?> (<?php echo $customer['customer_name_th'];?>)" >
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <textarea  id="debit_note_address" name="debit_note_address" class="form-control" rows="5" ><?php echo $customer['customer_address_1'] ."\n". $customer['customer_address_2'] ."\n". $customer['customer_address_3'];?></textarea >
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input  id="debit_note_tax" name="debit_note_tax" class="form-control" value="<?php echo $customer['customer_tax'];?>" >
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input id="debit_note_code" name="debit_note_code" class="form-control" value="<?php echo $last_code;?>" >
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="debit_note_due" name="debit_note_due"  class="form-control calendar" readonly/>
                                        <p class="help-block">01-03-2018 </p>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="debit_note_term" name="debit_note_term"  class="form-control"  />
