    ...
    function delete_row(id){
     ...
     function add_row(id){
        ...
        $(id).closest('table').children('tbody').append(
            '<tr class="odd gradeX">'+
                '<td>'+
                    '<input type="hidden" name="customer_delivery_note_supplier_list_id[]" value="0" />'+
...
<div class="row">
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            เพิ่มใบยืมสินค้าจากผู้ขาย /  Add delivery note supplier   
            </div>
            <!-- /.panel-heading -->
            <div class="panel-body">
                <form role="form" method="post" onsubmit="return check();" action="index.php?app=delivery_note_supplier&action=add" enctype="multipart/form-data">
                <div class="row">
                        <div class="col-lg-5">
                            <div class="row">
                                <div class="col-lg-5">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input id="delivery_note_supplier_code" name="delivery_note_supplier_code" class="form-control" value="<?php echo $last_code;?>" readonly>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="delivery_note_supplier_date" name="delivery_note_supplier_date" value="<?PHP echo $first_date; ?>"  class="form-control calendar" readonly/>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <textarea id="delivery_note_supplier_remark" name="delivery_note_supplier_remark"  class="form-control"></textarea>
                            ...
                            <tr class="odd gradeX">
                                <td>
                                    <select  class="form-control select" name="product_id[]" onchange="show_data(this);" data-live-search="true" >
                                        ...
                                        ?>
                                        <option <?php if($products[$ii]['product_id'] == $delivery_note_supplier_lists[$i]['product_id']){?> selected <?php }?> value="<?php echo $products[$ii]['product_id'] ?>"><?php echo $products[$ii]['product_code'] ?></option>
                                        <?
                                        }
                                        ?>
                                    </select>
