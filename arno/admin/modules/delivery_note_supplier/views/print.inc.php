...
<div class="row" >
    <div class="col-lg-12" style="margin-top:32px;">
        <div class="panel panel-default">
            ...
            ใบยืมสินค้าจากผู้ขาย / Delivery Note Supplier
            </div>
            <!-- /.panel-heading -->
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7 col-sm-7">
                                                    <div class="form-group">
                                                        ...
                                                        <p class="help-block"><?php echo $delivery_note_supplier['supplier_name_en'] ?> (<?php echo $delivery_note_supplier['supplier_name_th'] ?>)</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </td>
