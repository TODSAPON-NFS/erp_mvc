    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form  id="form_target" role="form" method="post" onsubmit="return check();" action="index.php?app=finance_credit&action=add" >
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="row">
                                <div class="col-lg-6">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="finance_credit_date" name="finance_credit_date"  class="form-control calendar" value="<?PHP echo $first_date?>" readonly/>
                    ...
                    <table width="100%" class="table table-striped table-bordered table-hover"  >
                        <thead>
                            <tr>
                                ...
                                <th style="text-align:center;max-width:100px;">ลงวันที่<br>(Paid date)</th> 
                                <th style="text-align:center;">ธนาคาร<br>(Bank)</th>
                                <th style="text-align:center;max-width:100px;">จำนวนเงิน<br>(Total)</th>
                                <th style="text-align:center;max-width:100px;">ยอดคงเหลือ<br>(Balance)</th>
                                <th style="text-align:center;max-width:100px;">ยอดชำระ<br>(Paid)</th>
                                <th></th>
                            </tr>
                        </thead>
                        <tbody>
