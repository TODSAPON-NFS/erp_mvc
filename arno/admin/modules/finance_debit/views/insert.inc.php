<script>
    ...
    function check_code(id){
        var code = $(id).val();
        $.post( "controllers/getFinanceDebitByCode.php", { 'finance_debit_code': code }, function( data ) {  
            if(data != null){ 
                alert("This "+code+" is already in the system.");
                document.getElementById("finance_debit_code").focus();
                $("#finance_check").val(data.finance_debit_id);
    ...
    function check(){
        ...
        if(finance_check != ""){
            alert("This "+finance_debit_code+" is already in the system.");
            document.getElementById("finance_debit_code").focus();
            return false;
            ...
            alert("Please input Finance Debit code.");
            document.getElementById("finance_debit_code").focus();
            return false;
    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form  id="form_target" role="form" method="post" onsubmit="return check();" action="index.php?app=finance_debit&action=add" >
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="row">
                                <div class="col-lg-6">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="finance_debit_date" name="finance_debit_date"  class="form-control calendar" value="<?PHP echo $first_date?>" readonly/>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input id="finance_debit_code" name="finance_debit_code" class="form-control" onchange="check_code(this)" value="<?php echo $last_code;?>" >
