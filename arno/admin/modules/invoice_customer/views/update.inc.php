        ...
        $(id).closest('table').children('tbody').append(
            '<tr class="odd gradeX">'+
                ...
                '<td>'+
                    ...
                    '<input type="text" class="invoice-supplier-ajax-post form-control" style="text-align:right;" name="invoice_supplier_code_gen[]" onchange="show_invoice_supplier_data(this);" value=""'+
                '</td>'+
                '<td align="center">'+
                                    ...
                                    <table name="tb_invoice_supplier_list"  class="table table-striped table-bordered table-hover" >
                                        ...
                                        <?php for($i=0; $i < count($invoice_customer_costs); $i++){ ?>
                                            <tr class="odd gradeX">'+
                                                ...
                                                <td align="center">
                                                <input type="text" class="form-control" style="text-align:right;" name="invoice_customer_cost_value[]" onchange="calculate_cost();" value="<?php echo number_format($invoice_customer_costs[$i]['invoice_customer_cost_value'],2); ?>" />
                                                </td>
                                                <td>
                                                    <a href="javascript:;" onclick="delete_row(this);" style="color:red;">
                                                        <i class="fa fa-times" aria-hidden="true"></i>
