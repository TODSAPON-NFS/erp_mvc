<script>
    ...
    function check(){
        ...
        if(date_check == "1"){
            ...
            document.getElementById("invoice_supplier_date_recieve").focus();
            return false;
        }else if(invoice_check != "" && invoice_check != invoice_supplier_id){
            ...
            <?PHP } ?>
                ...
                $(id).closest('table').children('tbody').append(
                    '<tr class="odd gradeX">'+
                        ...
                        '<td align="right"><input type="text" class="form-control" style="text-align: right;" autocomplete="off" name="purchase_order_list_price[]" onchange="update_sum(this);" value="'+ purchase_price.toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") +'" /></td>'+
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="invoice_supplier_date_recieve" name="invoice_supplier_date_recieve"  class="form-control calendar" value="<?PHP echo $invoice_supplier['invoice_supplier_date_recieve'];?>" onchange="check_date(this);"  readonly/>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input  id="invoice_supplier_stock" name="invoice_supplier_stock" onchange="" class="form-control" value="<?php echo $invoice_supplier['invoice_supplier_stock'];?>" onchange="" >
