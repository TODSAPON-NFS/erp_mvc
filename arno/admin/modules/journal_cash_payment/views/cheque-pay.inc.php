...
function edit_cheque_pay_row(id){
...
function add_cheque_pay_row(id){
...
function set_cheque_pay_row(data){
    ...
    if(row_cheque_pay_add_id != null){
        ...
        $(row_cheque_pay_update_id).closest('tr').children('td').children('span[name="display_check_pay_total"]').html(data.check_pay_total); 
    ...
    <tfoot>
        <tr class="odd gradeX">
            <td colspan="3" align="center">
                <a href="javascript:;" onclick="add_cheque_pay_row(this);" style="color:red;">
