...
function set_cheque_row(data){
    ...
    if(row_cheque_add_id != null){
        ...
        $(row_cheque_update_id).closest('tr').children('td').children('span[name="display_check_total"]').html(data.check_total); 
    ...
    <tfoot>
        <tr class="odd gradeX">
            <td colspan="3" align="center">
                <a href="javascript:;" onclick="add_cheque_row(this);" style="color:red;">
