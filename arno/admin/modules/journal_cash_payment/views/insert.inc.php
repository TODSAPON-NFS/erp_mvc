<script>
    ...
    function val_format(id){
        var val =  parseFloat($(id).val().replace(/,/g, ''));  
        console.log($(id).val().replace(/,/g, ''));
        if(isNaN(val)){
            val = 0;
        }
    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form id="form_target" role="form" method="post" onsubmit="return check();" action="index.php?app=journal_special_04&action=add" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-lg-4">
