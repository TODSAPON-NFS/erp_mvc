     ...
     function add_row(id){
        ...
        $(id).closest('table').children('tbody').append(
            '<tr class="odd gradeX">'+
                ...
                '<td align="right"><input type="text" class="form-control" style="text-align: right;" value="0" onchange="val_format(this);" name="journal_cash_payment_list_credit[]" onclick="edit_credit(this)" /></td>'+
                '<td>'+
            ...
            <div class="panel-heading">
                <div class="row">
                    ...
                    <div class="col-md-4" align="right">
                        ...
                        <?PHP if($next_id != ""){?>
                        <a class="btn btn-primary" href="?app=journal_special_04&action=update&id=<?php echo $next_id;?>" >  <?php echo $next_code;?> <i class="fa fa-angle-double-right" aria-hidden="true"></i> </a>
                        <?PHP } ?>
                    </div>
                </div> 
            </div>
                                ...
                                <?php 
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td align="right"><input type="text" class="form-control" style="text-align: right;" name="journal_cash_payment_list_debit[]"  onchange="val_format(this);" value="<?php echo number_format($journal_cash_payment_lists[$i]['journal_cash_payment_list_debit'],2); ?>"  onclick="edit_credit(this)" 
                                            ...
                                            <?PHP } ?>
                                        /></td>
                                        <td align="right"><input type="text" class="form-control" style="text-align: right;" name="journal_cash_payment_list_credit[]" onchange="val_format(this);" value="<?php echo number_format($journal_cash_payment_lists[$i]['journal_cash_payment_list_credit'],2); ?>"  onclick="edit_credit(this)" 
                                            <?PHP if(
                                                    $journal_cash_payment_lists[$i]['journal_cheque_id'] > 0 ||
                                                    $journal_cash_payment_lists[$i]['journal_cheque_pay_id'] > 0 ||
                                                    $journal_cash_payment_lists[$i]['journal_invoice_customer_id'] > 0 ||
