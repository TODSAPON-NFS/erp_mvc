...
function edit_invoice_supplier_row(id){
...
function add_invoice_supplier_row(id){
...
function set_invoice_supplier_row(data){
    ...
    if(row_invoice_supplier_add_id != null){
        ...
        $(row_invoice_supplier_add_id).closest('table').children('tbody').append(
            ...
            $('#tb_journal').children('tbody').append(
                '<tr class="odd gradeX">'+
                    ...
                    '</td>'+
                    '<td><input type="text" class="form-control" name="journal_cash_payment_list_name[]" value="' + data.invoice_supplier_remark + '" /></td>'+
        ...
        $(row_invoice_supplier_update_id).closest('tr').children('td').children('span[name="display_invoice_supplier_total_price[]"]').html(data.invoice_supplier_total_price); 
        $(row_invoice_supplier_update_id).closest('tr').children('td').children('span[name="display_invoice_supplier_vat_price[]"]').html(data.invoice_supplier_vat_price); 
        $(row_invoice_supplier_update_id).closest('tr').children('td').children('span[name="display_invoice_supplier_total_price_non[]"]').html(data.invoice_supplier_total_price_non); 
        $(row_invoice_supplier_update_id).closest('tr').children('td').children('span[name="display_invoice_supplier_vat_price_non[]"]').html(data.invoice_supplier_vat_price_non); 
    ...
    <tfoot>
        <tr class="odd gradeX">
            <td colspan="4" align="center">
                <a href="javascript:;" onclick="add_invoice_supplier_row(this);" style="color:red;">
            ...
            <table width="100%" class="table table-striped table-bordered table-hover" >
                ...
                <tbody> 
                    <tr class="odd gradeX">
                        ...
                        <td align="right"><input type="text" class="form-control" style="text-align: right;" id="invoice_supplier_vat_price" name="invoice_supplier_vat_price" readonly value="<?php echo $invoice_supplier['invoice_supplier_vat_price']; ?>" /></td>
                        ...
                        <td align="right"><input type="text" class="form-control" style="text-align: right;" id="invoice_supplier_vat_price_non" name="invoice_supplier_vat_price_non" readonly  value="<?php echo $invoice_supplier['invoice_supplier_vat_price_non']; ?>" /></td>
