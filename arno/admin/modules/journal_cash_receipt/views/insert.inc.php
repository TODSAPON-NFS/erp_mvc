<script>
    ...
    function find_journal_code(type){
        ...
        $.post( "controllers/getJournalReceiptByCode.php", { 'journal_cash_receipt_code': code }, function( data ) {  
            if(data !== null){ 
                if(type == "copy"){
                    console.log("Copy ",data);
                    window.location = "?app=journal_special_03&action=insert&id="+data.journal_cash_receipt_id;
                } else if(type == "edit"){
    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form role="form" method="post" onsubmit="return check();" action="index.php?app=journal_special_03&action=add" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label>หมายเลขสมุดรายวันรับเงิน / Journal Receipt Code <font color="#F00"><b>*</b></font></label>
                                <input id="journal_cash_receipt_code" name="journal_cash_receipt_code" class="form-control" value="<?php echo $last_code;?>"  />
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <input type="text" id="journal_cash_receipt_name" name="journal_cash_receipt_name"  class="form-control" value="" />
                    ...
                    <div class="row">
                        <div class="col-lg-offset-9 col-lg-3" align="right">
                            ...
                            <a href="index.php?app=journal_special_03&action=insert" class="btn btn-primary">Reset</a>
