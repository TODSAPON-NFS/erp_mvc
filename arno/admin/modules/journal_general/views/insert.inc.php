     ...
     function add_row(id){
        ...
        $(id).closest('table').children('tbody').append(
            '<tr class="odd gradeX">'+
                ...
                '<td align="right"><input type="text" class="form-control" style="text-align: right;" onchange="val_format(this);" name="journal_general_list_debit[]" value="0" /></td>'+
                '<td align="right"><input type="text" class="form-control" style="text-align: right;" onchange="val_format(this);" name="journal_general_list_credit[]" value="0" /></td>'+
                '<td>'+
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input id="journal_general_code" name="journal_general_code" class="form-control" value="<?php echo $last_code;?>" readonly>
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <input type="text" id="journal_general_name" name="journal_general_name"  class="form-control" value="" />
                    ...
                    <table width="100%" class="table table-striped table-bordered table-hover" >
                        ...
                        <tbody>
                            ...
                            <tr class="odd gradeX">
                                ...
                                <td align="right"><input type="text" class="form-control" style="text-align: right;" name="journal_general_list_debit[]" onchange="val_format(this);" value="<?php echo number_format($journal_general_lists[$i]['journal_general_list_debit'],0); ?>" /></td>
                                <td align="right"><input type="text" class="form-control" style="text-align: right;" name="journal_general_list_credit[]" onchange="val_format(this);" value="<?php echo number_format($journal_general_lists[$i]['journal_general_list_credit'],0); ?>" /></td>
                                <td>
                                    <a href="javascript:;" onclick="delete_row(this);" style="color:red;">
                                        <i class="fa fa-times" aria-hidden="true"></i>
                                    </a>
