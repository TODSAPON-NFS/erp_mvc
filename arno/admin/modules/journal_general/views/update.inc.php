<script>
    ...
    var options = {
        ...
        getValue: function(element) {
            return element.journal_general_code ;
        },

        template: {
            type: "description",
            fields: {
                description: "journal_general_name"
            }
        },
    ...
    function check_date(id){
        ...
        $.post( "controllers/checkPaperLockByDate.php", { 'date': val_date }, function( data ) {  
            if(data.result){ 
                ...
                $("#date_check").val("1");
                //$("#journal_general_date").val(data.date_now);
    ...
    function check(){
        ...
        var journal_general_id = document.getElementById("journal_general_id").value;
        ...
        if(date_check == "1"){
            alert("This "+journal_general_date+" is locked in the system.");
            document.getElementById("journal_general_date").focus();
            return false;
            ...
            document.getElementById("journal_general_code").focus();
            return false;
        }else if(journal_check != "" && journal_check != journal_general_id){
     ...
     function add_row(id){
        ...
        $(id).closest('table').children('tbody').append(
            '<tr class="odd gradeX">'+
                ...
                '</td>'+
                '<td><input type="text" class="form-control" name="journal_general_list_name[]" value="' + document.getElementById("journal_general_name").value + '" /></td>'+
                '<td align="right"><input type="text" class="form-control" style="text-align: right;"  value="0" onchange="val_format(this);" name="journal_general_list_debit[]" onclick="edit_credit(this)" /></td>'+
                '<td align="right"><input type="text" class="form-control" style="text-align: right;" value="0" onchange="val_format(this);" name="journal_general_list_credit[]" onclick="edit_credit(this)" /></td>'+
                '<td>'+
    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form  id="form_target" role="form" method="post" onsubmit="return check();" action="index.php?app=journal_general&action=edit&id=<?PHP echo $journal_general_id; ?>" enctype="multipart/form-data">
                <input id="journal_general_id" name="journal_general_id" value="<?PHP echo $journal_general['journal_general_id']; ?>" type="hidden" />
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input id="journal_general_code" name="journal_general_code" class="form-control" onchange="check_code(this)" value="<?php echo $journal_general['journal_general_code'];?>" >
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input type="text" id="journal_general_date" name="journal_general_date"  value="<?php echo $journal_general['journal_general_date'];?>" onchange="check_date(this);" class="form-control calendar" readonly/>
                                ...
                                <?php 
                                    ...
                                    <tr class="odd gradeX">
                                        <td>
                                            ...
                                            <input type="hidden" name="journal_cheque_id[]" value="<?php echo $journal_general_lists[$i]['journal_cheque_id']; ?>" /> 
                                            <input type="hidden" name="journal_cheque_pay_id[]" value="<?php echo $journal_general_lists[$i]['journal_cheque_pay_id']; ?>" /> 
                                            <input type="hidden" name="journal_invoice_customer_id[]" value="<?php echo $journal_general_lists[$i]['journal_invoice_customer_id']; ?>" />
                                            <input type="hidden" name="journal_invoice_supplier_id[]" value="<?php echo $journal_general_lists[$i]['journal_invoice_supplier_id']; ?>" /> 
                                            <input type="hidden" name="journal_general_list_id[]" value="<?php echo $journal_general_lists[$i]['journal_general_list_id']; ?>" />

                                            <select  class="form-control select" name="account_id[]" data-live-search="true"  onchange="get_account_type(this);" 
                                                <?PHP if(
                                                    $journal_general_lists[$i]['journal_cheque_id'] > 0 ||
                                                    $journal_general_lists[$i]['journal_cheque_pay_id'] > 0 ||
                                                    $journal_general_lists[$i]['journal_invoice_customer_id'] > 0 ||
                                                    $journal_general_lists[$i]['journal_invoice_supplier_id'] > 0 
                                                ){ ?>
                                                disabled
                                                <?PHP } ?>
                                             >
                                        ...
                                        <td align="right"><input type="text" class="form-control" style="text-align: right;" name="journal_general_list_debit[]"  onchange="val_format(this);" value="<?php echo number_format($journal_general_lists[$i]['journal_general_list_debit'],2); ?>"  onclick="edit_credit(this)" 
                                            <?PHP if(
                                                    $journal_general_lists[$i]['journal_cheque_id'] > 0 ||
                                                    $journal_general_lists[$i]['journal_cheque_pay_id'] > 0 ||
                                                    $journal_general_lists[$i]['journal_invoice_customer_id'] > 0 ||
                                            ...
                                            <?PHP } ?>
                                        /></td>
                                        <td align="right"><input type="text" class="form-control" style="text-align: right;" name="journal_general_list_credit[]" onchange="val_format(this);" value="<?php echo number_format($journal_general_lists[$i]['journal_general_list_credit'],2); ?>"  onclick="edit_credit(this)" 
                                            <?PHP if(
                                                    $journal_general_lists[$i]['journal_cheque_id'] > 0 ||
                                                    $journal_general_lists[$i]['journal_cheque_pay_id'] > 0 ||
                                                    $journal_general_lists[$i]['journal_invoice_customer_id'] > 0 ||
                    ...
                    <div class="row">
                        <div class="col-lg-offset-9 col-lg-3" align="right">
                            ...
                            <a href="index.php?app=journal_general&action=insert" class="btn btn-primary">Reset</a>
