        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <div class="row">
                    ...
                    <?PHP if($previous_id != ""){?>
                        <a class="btn btn-primary" href="?app=journal_purchase&action=update&id=<?php echo $previous_id;?>" > <i class="fa fa-angle-double-left" aria-hidden="true"></i> <?php echo $previous_code;?> </a>
                        <?PHP } ?>

                        <?PHP if($next_id != ""){?>
                        <a class="btn btn-primary" href="?app=journal_purchase&action=update&id=<?php echo $next_id;?>" >  <?php echo $next_code;?> <i class="fa fa-angle-double-right" aria-hidden="true"></i> </a>
                        <?PHP } ?>
                    </div>
                </div>  
            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input id="journal_purchase_code" name="journal_purchase_code" class="form-control" value="<?php echo $journal_purchase['journal_purchase_code'];?>" >
