                            ...
                            <tr class="odd gradeX">
                                <td>
                                    ...
                                    <select  class="form-control select" name="account_id[]" onchange="show_data(this);" data-live-search="true" >
                                        ...
                                        ?>
                                        <option <?php if($accounts[$ii]['account_id'] == $journal_purchase_lists[$i]['account_id']){?> selected <?php }?> value="<?php echo $accounts[$ii]['account_id'] ?>"><?php echo $accounts[$ii]['account_code'] ?></option>
                                        <?
                                        }
                                        ?>
                                    </select>
