     ...
     function add_row(id){
        ...
        $(id).closest('table').children('tbody').append(
            '<tr class="odd gradeX">'+
                ...
                '<td align="right"><input type="text" class="form-control" style="text-align: right;" value="0" onchange="val_format(this);" name="journal_sale_list_credit[]" /></td>'+
                '<td>'+
        ...
        $.post( "controllers/getJournalSaleByCode.php", { 'journal_sale_code': code }, function( data ) {  
            if(data !== null){ 
                if(type == "copy"){
                    ...
                    window.location = "?app=journal_special_02&action=insert&id="+data.journal_sale_id;
                } else if(type == "edit"){
                    console.log("Edit ", data);
                    window.location = "?app=journal_special_02&action=update&id="+data.journal_sale_id;
                }
            }else{  
                alert("Can not find Journal Sale : "+ code );
            } 
        });
    } 
    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form  id="form_target" role="form" method="post" onsubmit="return check();" action="index.php?app=journal_special_02&action=add" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label>หมายเลขสมุดรายวันขาย / Journal Sale Code <font color="#F00"><b>*</b></font></label>
                                <input id="journal_sale_code" name="journal_sale_code" class="form-control" onchange="check_code(this)" value="<?php echo $last_code;?>" >
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input type="text" id="journal_sale_date" name="journal_sale_date"  value="<?PHP echo $first_date;?>"  onchange="check_date(this);" class="form-control calendar" readonly/>
                            ...
                            <table id="tb_journal" width="100%" class="table table-striped table-bordered table-hover" >
                                ...
                                <?php 
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td align="right"><input type="text" class="form-control" style="text-align: right;" name="journal_sale_list_debit[]" onchange="val_format(this);" value="<?php echo number_format($journal_sale_lists[$i]['journal_sale_list_debit'],2); ?>"  onclick="edit_credit(this)" /></td>
                                        <td align="right"><input type="text" class="form-control" style="text-align: right;" name="journal_sale_list_credit[]" onchange="val_format(this);" value="<?php echo number_format($journal_sale_lists[$i]['journal_sale_list_credit'],2); ?>" onclick="edit_credit(this)" /></td>
                                        <td>
                                            <a href="javascript:;" onclick="delete_row(this);" style="color:red;">
                                                <i class="fa fa-times" aria-hidden="true"></i>
                                            </a>
