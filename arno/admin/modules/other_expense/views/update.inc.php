<script>
    ...
    function calculatePay(){
        ...
        var total = 0.0;
        for(var i = 0 ; i < val.length ; i++){
            if(isNaN(val[i].value.toString().replace(new RegExp(',', 'g'),''))){
                total += 0;
            }else{
                total += parseFloat(val[i].value.toString().replace(new RegExp(',', 'g'),''));
            }
...
<div class="row">
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            แก้ไขค่าใช้จ่ายอื่นๆ  / Edit Other Expense 
            </div>
            <!-- /.panel-heading -->
            <div class="panel-body">
                <form role="form" method="post" onsubmit="return check();" action="index.php?app=other_expense&action=edit&id=<?PHP echo $other_expense_id; ?>" >
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="other_expense_date" name="other_expense_date" value="<?PHP echo $other_expense['other_expense_date'];?>"  class="form-control calendar" readonly/>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input id="other_expense_code" name="other_expense_code" class="form-control" value="<?PHP echo $other_expense['other_expense_code'];?>" readonly>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="other_expense_bill_date" name="other_expense_bill_date" value="<?PHP echo $other_expense['other_expense_bill_date'];?>"  class="form-control calendar" readonly/>
                                        <p class="help-block">01-03-2018</p>
                                    </div>
                                </div>
