...
function search() {
    ...
    if (view_type == 'paper') {
        ...
        window.location = "index.php?app=purchase_order&action=view_list&date_start=" + date_start + "&date_end=" +
                        ...
                        <table width="100%" class="table table-striped table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td>
                                        <a
                                            href="?app=purchase_order&action=insert&supplier_id=<?php echo $supplier_orders[$i]['supplier_id'];?>">
                        ...
                        <table width="100%" class="table table-striped table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td>
                                        <a
                                            href="?app=purchase_order&action=insert&type=blanked&purchase_request_id=<?php echo $supplier_blankeds[$i]['purchase_request_id'];?>&supplier_id=<?php echo $supplier_blankeds[$i]['supplier_id'];?>">
                                            <i class="fa fa-plus-square" aria-hidden="true"></i>
                                        </a>
                        ...
                        <table width="100%" class="table table-striped table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td>
                                        <a
                                            href="?app=purchase_order&action=insert&type=test&supplier_id=<?php echo $supplier_tests[$i]['supplier_id'];?>">
                                            <i class="fa fa-plus-square" aria-hidden="true"></i>
                                        </a>
                        ...
                        <table width="100%" class="table table-striped table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td>
                                        <a
                                            href="?app=purchase_order&action=insert&type=regrind&supplier_id=<?php echo $supplier_regrinds[$i]['supplier_id'];?>">
                                            <i class="fa fa-plus-square" aria-hidden="true"></i>
                                        </a>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <a class="btn btn-warning " style="float:right;margin-left:8px;"
                            href="?app=purchase_order&action=insert&type=test"><i class="fa fa-plus"
                                aria-hidden="true"></i> Add Test Order</a>
                        <a class="btn btn-danger " style="float:right;margin-left:8px;"
                            href="?app=purchase_order&action=insert&type=blanked"><i class="fa fa-plus"
                                aria-hidden="true"></i> Add Blanked Order</a>
                        <a class="btn btn-success " style="float:right;margin-left:8px;"
                            href="?app=purchase_order&action=insert&type=standard"><i class="fa fa-plus"
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <a href="index.php?app=purchase_order" class="btn btn-default"
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th class="datatable-th" data-container="body" data-toggle="tooltip"
                                        ...
                                        Invoice Code</th>
                                    <th class="datatable-th" data-container="body" data-toggle="tooltip"
                                        data-placement="top" title="" data-original-title="สถานะ" width="102">Ststus
                                    </th>
                            ...
                            <tbody>
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td class="text-center">
                                        ...
                                        <b>
                                            <a class="text-success"
                                                href="?app=purchase_order&action=sending&id=<?php echo $purchase_orders[$i]['purchase_order_id'];?>&supplier_id=<?php echo $purchase_orders[$i]['supplier_id'];?>"
                                                title="Send">
                                        ...
                                        <div>
                                            ...
                                            <b>
                                                <a href="?app=purchase_order&action=update_sending&id=<?php echo $purchase_orders[$i]['purchase_order_id'];?>"
                                                    title="Confirm">
                                            ...
                                            <b>
                                                <a style="float: right;" class="text-danger"
                                                    href="?app=purchase_order&action=cancel_sending&id=<?php echo $purchase_orders[$i]['purchase_order_id'];?>"
                                                    title="Cancel">
                                    ...
                                    // echo  $purchase_orders[$i]['purchase_order_id'];
                                        ...
                                        if($invoice_supplier[$i]['invoice_supplier_list_qty'] == $invoice_supplier[$i]['purchase_order_list_qty']) {
                                    ?>
                                        <B>
                                            <p class="font-weight-bold text-success">ครบ</p>
                                        </b>
                                        <?PHP 
                                        } else if($invoice_supplier[$i]['invoice_supplier_list_qty'] > $invoice_supplier[$i]['purchase_order_list_qty']) {
                                    ?>
                                        <B>
                                    ...
                                    <td>
                                        <a
                                            href="?app=purchase_order&action=detail&id=<?php echo $purchase_orders[$i]['purchase_order_id'];?>">
                                        ...
                                        <a href="?app=purchase_order&action=cancelled&id=<?php echo $purchase_orders[$i]['purchase_order_id'];?>"
                                        ...
                                        <a href="?app=purchase_order&action=rewrite&id=<?php echo $purchase_orders[$i]['purchase_order_id'];?>"
                                        ...
                                        <?PHP if( $license_purchase_page == "Medium" || $license_purchase_page == "High"){ ?>
                                        <a href="?app=purchase_order&action=uncancelled&id=<?php echo $purchase_orders[$i]['purchase_order_id'];?>"
                                        ...
                                        <a href="?app=purchase_order&action=delete&id=<?php echo $purchase_orders[$i]['purchase_order_id'];?>"
