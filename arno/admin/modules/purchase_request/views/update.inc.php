    ...
    function add_row(id){ 
        ...
        $(id).closest('table').children('tbody').append(
            '<tr class="odd gradeX">'+
                ...
                '</td>'+
                '<td>'+
                    '<input type="text" class="form-control" style="text-align:right;" name="purchase_request_list_qty[]" autocomplete="off"  value="1"/>'+ 
                '</td>'+
                    ...
                    for(var i = 0 ; i < $("#order_number").val() ; i++){
                        ...
                        $(id).closest('table').children('tbody').append(
                            '<tr class="odd gradeX">'+
                                ...
                                '</td>'+
                                '<td>'+
                                    '<input type="text" class="form-control" style="text-align:right;" name="purchase_request_list_qty[]" autocomplete="off"  value="'+ $('#order_qty').val() +'"/>'+ 
                                '</td>'+
                                '<td><input type="text" class="form-control" name="purchase_request_list_delivery[]" readonly /></td>'+
                                '<td><input type="text" class="form-control" name="purchase_request_list_remark[]" /></td>'+
                                '<td>'+
