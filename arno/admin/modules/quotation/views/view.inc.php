                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td>
                                            <a href="?app=quotation&action=detail&id=<?php echo $quotations[$i]['quotation_id'];?>">
                                                <i class="fa fa-file-text-o" aria-hidden="true"></i>
                                            </a>
                                            
                                        <?php if($quotations[$i]['quotation_cancelled'] == 0){ ?>
                                            <a href="?app=quotation&action=update&id=<?php echo $quotations[$i]['quotation_id'];?>">
                                                <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                                            </a>
                                            <a href="?app=quotation&action=cancelled&id=<?php echo $quotations[$i]['quotation_id'];?>" onclick="return confirm('You want to cancel quotation : <?php echo $quotations[$i]['quotation_code']; ?>');" >
                                                <i class="fa fa-ban" aria-hidden="true"></i>
                                            </a>
                                        <?php } else { ?>
                                            <a href="?app=quotation&action=uncancelled&id=<?php echo $quotations[$i]['quotation_id'];?>" onclick="return confirm('You want to uncancelled quotation : <?php echo $quotations[$i]['quotation_code']; ?>');" style="color:#F00;">
                                                <i class="fa fa-ban" aria-hidden="true"></i>
                                            </a>
                                        <?PHP } ?>
                                            <a href="?app=quotation&action=delete&id=<?php echo $quotations[$i]['quotation_id'];?>" onclick="return confirm('You want to delete quotation : <?php echo $quotations[$i]['quotation_code']; ?>');" style="color:red;">
