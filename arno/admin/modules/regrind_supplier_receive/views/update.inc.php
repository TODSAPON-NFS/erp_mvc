                ...
                if(data.length > 0){
                    ...
                    for(var i = 0; i < data.length ; i++){
                        ...
                        content += '<tr class="odd gradeX">'+
                                    ...
                                    '</td>'+
                                    '<td align="right">'+
                                        data[i].regrind_supplier_receive_list_qty +
                                    '</td>'+
                                    '<td align="right">'+
                                        data[i].regrind_supplier_receive_list_remark+
                                    '</td>'+
                                '</tr>';
...
<div class="row">
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            แก้ไขใบยืมสินค้าจากผู้ขาย / Update Regrind supplier receive   
            </div>
            <!-- /.panel-heading -->
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input id="contact_name" name="contact_name" class="form-control" value="<?PHP echo $regrind_supplier_receive['contact_name']; ?>">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input id="regrind_supplier_receive_code" name="regrind_supplier_receive_code" class="form-control" value="<?PHP echo $regrind_supplier_receive['regrind_supplier_receive_code']; ?>" readonly>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="regrind_supplier_receive_date" name="regrind_supplier_receive_date" value="<?PHP echo $regrind_supplier_receive['regrind_supplier_receive_date']; ?>"  class="form-control calendar" readonly/>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <select id="employee_id" name="employee_id" class="form-control select" data-live-search="true">
                                            ...
                                            ?>
                                            <option value="<?php echo $users[$i]['user_id'] ?>" <?PHP if($users[$i]['user_id'] == $regrind_supplier_receive['employee_id']){ ?> selected <?PHP } ?> ><?php echo $users[$i]['name'] ?> (<?php echo $users[$i]['user_position_name'] ?>)</option>
                                            <?
                                            }
                                            ?>
                                        </select>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <textarea id="regrind_supplier_receive_remark" name="regrind_supplier_receive_remark"  class="form-control"><?PHP echo $regrind_supplier_receive['regrind_supplier_receive_remark']; ?></textarea>
                        ...
                        <tbody>
                            ...
                            <tr class="odd gradeX">
                                <td>
                                    ...
                                    <input type="hidden" name="regrind_supplier_receive_list_id[]" value="<?php echo $regrind_supplier_receive_lists[$i]['regrind_supplier_receive_list_id']; ?>" />
                                    <select  class="form-control select" name="product_id[]" onchange="show_data(this);" data-live-search="true" >
                                        ...
                                        ?>
                                        <option <?php if($products[$ii]['product_id'] == $regrind_supplier_receive_lists[$i]['product_id']){?> selected <?php }?> value="<?php echo $products[$ii]['product_id'] ?>"><?php echo $products[$ii]['product_code'] ?></option>
                                        <?
                                        }
                                        ?>
                                    </select>
