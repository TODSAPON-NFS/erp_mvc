                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td data-order="<?php echo  $timestamp = strtotime(  $regrind_supplier_receives[$i]['regrind_supplier_receive_date'] )?>" >
                                            <?php echo (  $regrind_supplier_receives[$i]['regrind_supplier_receive_date'] ); ?>
                                        </td>
