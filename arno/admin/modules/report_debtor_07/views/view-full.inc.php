<script>
    ...
    function print(type){
        ...
        window.open("print.php?app=report_debtor_07&action="+type+"&date_end="+date_end+"&customer_id="+customer_id+"&view_type="+view_type,'_blank');
    }
</script>

<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">รายงานวิเคราะห์อายุลูกหนี้</h1>
    </div>
    <!-- /.col-lg-12 -->
</div>
