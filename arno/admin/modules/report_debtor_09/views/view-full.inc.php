                ...
                <table width="100%" class="table table-striped table-bordered table-hover" >
                    ...
                    <tbody>
                        ...
                        <tr class="odd gradeX">
                            ...
                            <td><?php echo $debtor_reports[$i]['customer_branch']; ?></td> 
                            <td><?php echo $debtor_reports[$i]['customer_domestic']; ?></td> 
                            <td><?php echo $debtor_reports[$i]['customer_tax']; ?></td> 
                            <td><?php echo $debtor_reports[$i]['customer_address_1']." ".$debtor_reports[$i]['customer_address_2']." ".$debtor_reports[$i]['customer_address_3']." ".$debtor_reports[$i]['customer_zipcode']; ?></td> 
