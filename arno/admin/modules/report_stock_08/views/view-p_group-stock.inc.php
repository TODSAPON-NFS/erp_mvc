<script>
    function search(){ 
        ...
        window.location = "index.php?app=report_stock_08&date_start="+date_start+"&date_end="+date_end+"&stock_start="+stock_start+"&stock_end="+stock_end+"&product_start="+product_start+"&product_end="+product_end+"&sort="+sort ;
    }
    function print(type){
        var date_start = $("#date_start").val();
        var date_end = $("#date_end").val(); 
                ...
                <div class="row">
                    <div class="col-md-4">
                        <select id="sort" name="sort" class="form-control ">
                            ...
                            <option value="2">ProductGroup</option>
                        </select> 
                    </div>
                    <div class="col-lg-2">
                ...
                <table width="100%" class="table table-striped table-bordered table-hover" >
                    ...
                    <tbody>
                        ...
                        for($i=0; $i < count($stock_reports); $i++){ 
                            $product_list++;
                            if( $stock_reports[$i]['stock_group_code'] != $stock_group_code){ 
                                $stock_group_code = $stock_reports[$i]['stock_group_code'];
                                ...
                                <tr class="text-center">
                                    <td colspan="4" >
                                        <b style="color:blue;"><?php echo $stock_reports[$i]['stock_group_name']; ?></b>
                                    </td> 
                            ...
                            if($stock_reports[$i+1]['stock_group_code'] != $stock_group_code){  ?>
                                <tr class="">
