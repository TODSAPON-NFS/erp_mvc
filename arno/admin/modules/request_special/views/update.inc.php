...
<div class="row">
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            แก้ไขใบร้องขอสั่งซื้อสินค้าทดลองพิเศษ / Edit Special Tool Request  
            </div>
            <!-- /.panel-heading -->
            <div class="panel-body">
                <form role="form" method="post" onsubmit="return check();" action="index.php?app=request_special&action=edit&id=<?php echo $request_special_id;?>" >
                    <input type="hidden"  id="request_special_id" name="request_special_id" value="<?php echo $request_special_id; ?>" />
                    <input type="hidden"  id="request_special_date" name="request_special_date" value="<?php echo $request_special['request_special_date']; ?>" />
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label>หมายเลขใบร้องขอสั่งซื้อสินค้าทดลองพิเศษ / SPTR Code <font color="#F00"><b>* </b></font> <?php if($request_special['request_special_rewrite_no'] > 0){ ?><b><font color="#F00">Rewrite <?PHP echo $request_special['request_special_rewrite_no']; ?></font></b> <?PHP } ?></label>
                                <input id="request_special_code" name="request_special_code" class="form-control"  value="<? echo $request_special['request_special_code'];?>" readonly>
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <select id="employee_id" name="employee_id" class="form-control select"  data-live-search="true">
                                    ...
                                    ?>
                                    <option <?php if($users[$i]['user_id'] == $request_special['employee_id']){?> selected <?php }?> value="<?php echo $users[$i]['user_id'] ?>"><?php echo $users[$i]['name'] ?> (<?php echo $users[$i]['user_position_name'] ?>)</option>
                                    <?
                                    }
                                    ?>
                                </select>
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input type="checkbox" class="form-control" name="purchase_order_open"  value="1" <?php if($request_special['purchase_order_open'] == '1'){ echo "checked"; } ?> />
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <select id="customer_id" name="customer_id" class="form-control"  data-live-search="true">
                                    ...
                                    ?>
                                    <option <?php if($customers[$i]['customer_id'] == $request_special['customer_id']){?> selected <?php }?> value="<?php echo $customers[$i]['customer_id'] ?>"><?php echo $customers[$i]['customer_name_th'] ?> (<?php echo $customers[$i]['customer_name_en'] ?>)</option>
                                    <?
                                    }
                                    ?>
                                </select>
                            ...
                            <tr class="odd gradeX">
                                <td>
                                    ...
                                    <select  class="form-control select" name="product_id[]" onchange="show_data(this);" data-live-search="true" >
                                        ...
                                        ?>
                                        <option <?php if($products[$ii]['product_id'] == $request_special_lists[$i]['product_id']){?> selected <?php }?> value="<?php echo $products[$ii]['product_id'] ?>"><?php echo $products[$ii]['product_code'] ?></option>
                                        <?
                                        }
                                        ?>
                                    </select>
