                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input id="request_test_code" name="request_test_code" class="form-control" value="<?php echo $last_code;?>" readonly>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="request_test_date" name="request_test_date" value="<?PHP echo $first_date; ?>" class="form-control calendar" readonly/>
