...
<div class="row">
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            แก้ไขใบตัดคลังสินค้า /  Edit Stock Issue   
            </div>
            <!-- /.panel-heading -->
            <div class="panel-body">
            <form id="form_target" role="form" method="post" onsubmit="return check();" action="index.php?app=stock_issue&action=edit&id=<?PHP echo $stock_issue_id?>" enctype="multipart/form-data">
                <input type="hidden" name="stock_issue_id" id="stock_issue_id" value="<?PHP echo $stock_issue_id?>"  />
                <div class="row">
                        <div class="col-lg-5">
                            <div class="row">
                            <div class="col-lg-6">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input  id="invoice_customer_name" name="invoice_customer_name" class="form-control" value="<?php echo $stock_issue['invoice_customer_name'];?>" >
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <textarea  id="invoice_customer_address" name="invoice_customer_address" class="form-control" rows="5" ><?php echo $stock_issue['invoice_customer_address'];?></textarea >
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input  id="invoice_customer_tax" name="invoice_customer_tax" class="form-control" value="<?php echo $stock_issue['invoice_customer_tax'];?>" >
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input  id="employee_name" name="employee_name" class="form-control" value="<?php echo $stock_issue['invoice_employee_name'];?>" >
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input  id="invoice_customer_total_price" name="invoice_customer_total_price" class="form-control" value="<?php echo $stock_issue['invoice_customer_total_price'];?>" >
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input id="stock_issue_code" name="stock_issue_code" class="form-control" value="<?php echo $stock_issue['stock_issue_code'];?>" readonly>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <select id="employee_id" name="employee_id" class="form-control select" data-live-search="true">
                                            ...
                                            ?>
                                            <option value="<?php echo $users[$i]['user_id'] ?>" <?PHP if($users[$i]['user_id'] == $stock_issue['employee_id']){?> SELECTED <?PHP }?>><?php echo $users[$i]['name'] ?> (<?php echo $users[$i]['user_position_name'] ?>)</option>
                                            <?
                                            }
                                            ?>
                                        </select>
