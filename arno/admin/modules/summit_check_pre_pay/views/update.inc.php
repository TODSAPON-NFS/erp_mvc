...
<div class="row">
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            แก้ไขเช็คจ่ายล่วงหน้ายกยอดมา /  Edit Check  Pay
            </div>
            <!-- /.panel-heading -->
            <div class="panel-body">
                <form id="form_target" role="form" method="post" onsubmit="return check();" action="index.php?app=summit_check_pre_pay&action=edit&id=<?PHP echo  $check_pay_id; ?>" enctype="multipart/form-data">
                <div class="row">
                        <div class="col-lg-12">
                            <div class="row">
                                <div class="col-lg-2">
                    ...
                    <div class="row">
                        <div class="col-lg-offset-9 col-lg-3" align="right">
                            <a href="index.php?app=summit_check_pre_pay" class="btn btn-default">Back</a>
