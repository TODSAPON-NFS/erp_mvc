<script>
    function search(){
        ...
        window.location = "index.php?app=summit_check_pre_pay&date_start="+date_start+"&date_end="+date_end+"&supplier_id="+supplier_id+"&keyword="+keyword;
    }
</script>
    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                <div class="row">
                    <div class="col-md-8">
                        รายการเช็คจ่ายล่วงหน้ายกยอดมา / Check Pay List
                    </div>
                    <div class="col-md-4">
                        <a class="btn btn-success " style="float:right;" href="?app=summit_check_pre_pay&action=insert" ><i class="fa fa-plus" aria-hidden="true"></i> Add</a>
                    </div>
                </div>
            </div>
            <!-- /.panel-heading -->
                    ...
                    <tbody>
                        ...
                        <tr class="odd gradeX">
                            ...
                            <td>
                                ...
                                <a href="?app=summit_check_pre_pay&action=detail&id=<?php echo $checks[$i]['check_pay_id'];?>">
                                    <i class="fa fa-file-text-o" aria-hidden="true"></i>
                                </a>

                                <a href="?app=summit_check_pre_pay&action=update&id=<?php echo $checks[$i]['check_pay_id'];?>">
                                    <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                                </a> 
                                <a href="?app=summit_check_pre_pay&action=delete&id=<?php echo $checks[$i]['check_pay_id'];?>" onclick="return confirm('You want to delete check : <?php echo $checks[$i]['check_pay_code']; ?>');" style="color:red;">
