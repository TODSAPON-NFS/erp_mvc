    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form role="form" method="post" onsubmit="return check();" action="index.php?app=supplier&action=add" enctype="multipart/form-data">
                    ...
                    <div class="col-lg-2">
                        <div class="form-group">
                            ...
                            <select id="currency_id" name="currency_id" class="form-control">
                                ...
                                ?>
                                    <option value="<?PHP echo $currency[$i]['currency_id'];?>"><?PHP echo $currency[$i]['currency_code'];?> - <?PHP echo $currency[$i]['currency_name'];?></option>
                                <?PHP
                                    }
                                ?>
                            </select>
