...
<div class="row">
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <!-- /.panel-heading -->
            <div class="panel-body">
                <form role="form"  id="form_target" method="post" onsubmit="return check();" action="index.php?app=supplier_logistic&action=edit&id=<?php  echo $supplier_id?>" enctype="multipart/form-data">
                    <input type="hidden" id="supplier_logistic_id" name="supplier_logistic_id" value="<?php  echo $supplier_logistic_id?>"/>
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label>Logistic name<font color="#F00"><b>*</b></font></label>
                                <input id="supplier_logistic_name" name="supplier_logistic_name"  class="form-control" value="<?php  echo $supplier_logistic['supplier_logistic_name'];?>">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input id="supplier_logistic_detail" name="supplier_logistic_detail" class="form-control" value="<?php  echo $supplier_logistic['supplier_logistic_detail'];?>">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input id="supplier_logistic_lead_time" name="supplier_logistic_lead_time" class="form-control" value="<?php  echo $supplier_logistic['supplier_logistic_lead_time'];?>">
