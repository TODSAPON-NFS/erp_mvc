...
header("Content-Disposition: attachment; filename=credit-note-report_$d1-$d2-$d3 $d4:$d5:$d6.xls");
...
<h2 >รายงานใบลดหนี้/ใบคืนสินค้า ตั้งแต่วันที่ <?PHP echo $date_start; ?> ถึง <?PHP echo $date_end; ?></h2>
</div>
<br>
