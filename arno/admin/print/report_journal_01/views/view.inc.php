...
$cr_total = 0;
 ...
 while($i <  $row_max ){
    ...
    <table width="100%" border="0" cellspacing="0">
        <tr>
            <td align="left" > </td>
            <td colspan = "2" align="left" style="font-size:13px;"> PURCHASE VOUCHER </td> 
        </tr>
        <tr>
            <td align="left" ></td>
            <td width="60px" align="left" ><b>เลขที่</b></td>
            <td width="120px" align="left">'.$journal_purchase['journal_purchase_code'].'</td>
        </tr>
        <tr>
            <td align="left" ></td>
            <td align="left" ><b>วันที่</b></td>
            <td align="left" >'.$journal_purchase['journal_purchase_date'].'</td>
        </tr> 
    </table>  
    <br>
    <div style="font-size:13px;"><b>สมุดรายวันซื้อ</div>
    <div style="font-size:13px;"><b>รายละเอียด :</b> '.$journal_purchase['journal_purchase_name'].' </div>
