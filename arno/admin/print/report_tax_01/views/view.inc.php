    ...
    <table  width="100%" cellspacing="0" style="font-size:12px;">
        <thead>
            <tr>
                ...
                <th colspan="3" align="center" style="border-bottom: 1px dotted black;" >ใบกำกับภาษี</th>
    ...
    for($i=$page_index * $lines; $i < count($tax_reports) && $i < $page_index * $lines + $lines; $i++){
        ...
        $net_total +=  $tax_reports[$i]['invoice_supplier_net_price'];
                ...
                <tr>
                    ...
                    <td>
                        '.$tax_reports[$i]['invoice_supplier_remark'].'
                    </td>
                </tr> 
                ';
    }
    ...
    if($page_index+1 < $page_max){
        $html[$page_index] .= ' 
                ...
                <tfoot>
                    <tr>
                        <td></td>
                        <td colspan="7" align="left"> <b>รวมแต่ละหน้า</b> </td>
        ...
        $html[$page_index] .= ' 
                ...
                <tfoot>
                    ...
                    <tr>
                        <td></td>
                        <td colspan="7" align="left"><div><b>รวมทั้งสิ้น งวด </b> '.$section_date.' (<b>เริ่มจาก</b> '.$date_start.' <b>ถึง</b> '.$date_end.') </div> </td>
