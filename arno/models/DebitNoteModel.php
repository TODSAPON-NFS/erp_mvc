...
class DebitNoteModel extends BaseModel{
    ...
    function getDebitNoteBy($date_start = "",$date_end = "",$customer_id = "",$keyword = "",$user_id = "", $lock_1 = "0", $lock_2 = "0" ){
        ...
        LEFT JOIN tb_paper_lock ON SUBSTRING(tb_debit_note.debit_note_date,3,9)=SUBSTRING(tb_paper_lock.paper_lock_date,3,9) 
        WHERE ( 
