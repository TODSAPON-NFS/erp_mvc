...
class InvoiceCustomerListModel extends BaseModel{
    ...
    function deleteInvoiceCustomerListByInvoiceCustomerIDNotIN($id,$data){
        ...
        $sql = "UPDATE  tb_customer_purchase_order_list SET invoice_customer_list_id = '0'  WHERE invoice_customer_list_id IN (SELECT invoice_customer_list_id FROM tb_invoice_customer_list WHERE invoice_customer_id = '$id' AND invoice_customer_list_id NOT IN ($str)) ";
