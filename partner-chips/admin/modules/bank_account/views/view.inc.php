                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form role="form" method="post" onsubmit="return check();" <?php if($bank_account_id == ''){ ?>action="index.php?app=bank_account&action=add"<?php }else{?> action="index.php?app=bank_account&action=edit" <?php }?> enctype="multipart/form-data">
