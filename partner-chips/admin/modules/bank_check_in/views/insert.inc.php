    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form  id="form_target" role="form" method="post" onsubmit="return check();" action="index.php?app=bank_check_in&action=add" enctype="multipart/form-data">
                <div class="row">
                        <div class="col-lg-12">
                            <div class="row">
                                <div class="col-lg-2">
                                ...
                                <div class="col-lg-2">
                                    <div class="form-group">
                                        ...
                                        <input id="check_total" name="check_total" onchange="format_number(this);" style="text-align:right;" class="form-control " value="" >
