...
<div class="row">
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <!-- /.panel-heading -->
            <div class="panel-body">
                <form  id="form_target" role="form" method="post" onsubmit="return check();" action="index.php?app=customer_logistic&action=edit&id=<?php echo $customer_id?>" enctype="multipart/form-data">
                    <input type="hidden" id="customer_logistic_id" name="customer_logistic_id" value="<?php echo $customer_logistic_id?>"/>
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label>Logistic name<font color="#F00"><b>*</b></font></label>
                                <input id="customer_logistic_name" name="customer_logistic_name"  class="form-control" value="<? echo $customer_logistic['customer_logistic_name'];?>">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input id="customer_logistic_detail" name="customer_logistic_detail" class="form-control" value="<? echo $customer_logistic['customer_logistic_detail'];?>">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input id="customer_logistic_lead_time" name="customer_logistic_lead_time" class="form-control" value="<? echo $customer_logistic['customer_logistic_lead_time'];?>">
