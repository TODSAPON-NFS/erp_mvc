<<<<<<< HEAD:arno/admin/modules/detail_product/views/view.inc.php
<div class="row">
    <!-- /.col-lg-12 -->
                ...
                <div class="tab-content" id="myTabContent">
                    ...
                    <div class="tab-pane fade "  id="stock" role="tabpanel" aria-labelledby="stock-tab">
                        ...
                        <table width="100%" class="table table-striped table-bordered table-hover" >
                            ...
                            <tbody class="odd gradeX">
                                <td>
                                   <a href="index.php?app=search_product&stock_group_id=<?PHP  echo  $stock_report[$i] ['stock_group_id'] ?>" target="_bank"> <?php echo  $stock_report[$i] ['stock_group_name']?></a>
                                </td>
                                <td>
                    ...
                    <table width="100%" class="table table-striped table-bordered table-hover" >
                        ...
                        <tbody class="odd gradeX">
                            ...
                            <td>
                            <?php echo $stock_report[$i] ['currency_sign'] ?>  <?php echo number_format($stock_report[$i] ['product_buyprice'],2) ?>  
                            </td>
                    ...
                    <table width="100%" class="table table-striped table-bordered table-hover" >
                        ...
                        <tbody class="odd gradeX">
                            ...
                            <td>
                            <?php echo $stock_report[$i] ['currency_sign'] ?>  <?php echo number_format($stock_report[$i] ['product_price'],2) ?>
                            </td>
...
>>>>>>> bfe174f8f8a6ccd61604b3210c62329d9f03ccee:partner-chips/admin/modules/detail_product/views/view.inc.php
