<script>
    ...
    function get_supplier_detail(){
        ...
        $.post( "controllers/getSupplierByID.php", { 'supplier_id': supplier_id }, function( data ) {
            ...
            document.getElementById('invoice_supplier_vat').value = data.vat ;
...
<div class="row">
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            เพิ่มใบกำกับภาษีเจ้าหนี้ยกยอดมา / Add Invoice Supplier Begin 
            </div>
            <!-- /.panel-heading -->
            <div class="panel-body">
                <form id="form_target" role="form" method="post" onsubmit="return check();" action="index.php?app=summit_credit&action=add" >
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="row">
                                <div class="col-lg-6">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="invoice_supplier_date" name="invoice_supplier_date" value="<?PHP echo $first_date;?>" onchange="generate_credit_date();" class="form-control calendar" readonly/>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input id="invoice_supplier_code" name="invoice_supplier_code" class="form-control" value="<?php echo $last_code;?>" />
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="invoice_supplier_due" name="invoice_supplier_due"  class="form-control calendar" onchange="generate_credit_date();" readonly/>
                                        <p class="help-block">01-03-2018 </p>
                                    </div>
                                </div>
                    ...
                    <table width="100%" class="table table-striped table-bordered table-hover" >
                        ...
                        <tfoot>
                            <tr class="odd gradeX">
                                ...
                                <td width="200px" >
                                    <input type="text" class="form-control" style="text-align: right;" id="invoice_supplier_total_price" name="invoice_supplier_total_price" onchange="calculateAll()" value=""  />
                                </td>
                            </tr>
                            <tr class="odd gradeX">
                                <td width="300px" align="left" style="vertical-align: middle;">
                                    <table>
                                        <tr>
                                            ...
                                            <td style = "padding-left:8px;padding-right:8px;width:72px;">
                                                <input type="text" class="form-control" style="text-align: right;" onchange="calculateAll()" id="invoice_supplier_vat" name="invoice_supplier_vat" value="<?PHP echo $vat;?>" />
                                            </td>
                                            <td>
                                            %
                                            </td>
                                ...
                                <td width="200px">
                                    <input type="text" class="form-control" style="text-align: right;" id="invoice_supplier_vat_price"  name="invoice_supplier_vat_price" value=""  readonly/>
                                </td>
                            </tr>
                            <tr class="odd gradeX">
                                <td width="300px" align="left" style="vertical-align: middle;">
                                ...
                                <td width="200px">
                                    <input type="text" class="form-control" style="text-align: right;" id="invoice_supplier_net_price" name="invoice_supplier_net_price" value="" readonly/>
                                </td>
                            </tr>
                        </tfoot>
                    </table>   
