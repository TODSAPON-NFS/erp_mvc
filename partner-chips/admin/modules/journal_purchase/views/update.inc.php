     ...
     function add_row(id){
        ...
        $(id).closest('table').children('tbody').append(
            '<tr class="odd gradeX">'+
                ...
                '<td align="right"><input type="text" class="form-control" style="text-align: right;" onchange="val_format(this);" name="journal_purchase_list_debit[]"  /></td>'+
                '<td align="right"><input type="text" class="form-control" style="text-align: right;" onchange="val_format(this);" name="journal_purchase_list_credit[]" /></td>'+
                '<td>'+
                    ...
                    <table width="100%" class="table table-striped table-bordered table-hover" >
                        ...
                        <tbody>
                            ...
                            <tr class="odd gradeX">
                                ...
                                <td align="right"><input type="text" class="form-control" style="text-align: right;" onchange="val_format(this);" name="journal_purchase_list_debit[]" value="<?php echo $journal_purchase_lists[$i]['journal_purchase_list_debit']; ?>" /></td>
                                <td align="right"><input type="text" class="form-control" style="text-align: right;" onchange="val_format(this);" name="journal_purchase_list_credit[]" value="<?php echo $journal_purchase_lists[$i]['journal_purchase_list_credit']; ?>" /></td>
                                <td>
                                    <a href="javascript:;" onclick="delete_row(this);" style="color:red;">
                                        <i class="fa fa-times" aria-hidden="true"></i>
                                    </a>
