...
<div class="row">
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            เพิ่มใบเสร็จ / Add Official Receipt  
            </div>
            <!-- /.panel-heading -->
            <div class="panel-body">
                <form role="form" method="post" onsubmit="return check();" action="index.php?app=official_receipt&action=add" >
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="row">
                                <div class="col-lg-6">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input  id="official_receipt_name" name="official_receipt_name" class="form-control" value="<?php echo $customer['customer_name_en'];?> (<?php echo $customer['customer_name_th'];?>)" >
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <textarea  id="official_receipt_address" name="official_receipt_address" class="form-control" rows="5" ><?php echo $customer['customer_address_1'] ."\n". $customer['customer_address_2'] ."\n". $customer['customer_address_3'];?></textarea >
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input  id="official_receipt_tax" name="official_receipt_tax" class="form-control" value="<?php echo $customer['customer_tax'];?>" >
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input id="official_receipt_code" name="official_receipt_code" class="form-control" value="<?php echo $last_code;?>" >
