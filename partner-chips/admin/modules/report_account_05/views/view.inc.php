<script>
    function search(){ 
        ...
        window.location = "index.php?app=report_account_05&date_end="+date_end+"&code_start="+code_start+"&code_end="+code_end+"&keyword="+keyword ;
    }
    function print(type){ 
        var date_end = $("#date_end").val(); 
        var code_start = $("#code_start").val(); 
        ...
        window.location = "print.php?app=report_account_05&action="+type+"&date_end="+date_end+"&code_start="+code_start+"&code_end="+code_end+"&keyword="+keyword ;
    }
</script>
