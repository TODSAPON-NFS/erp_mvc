...
$path = "modules/report_creditor_01/views/";
...
$creditor_reports = $creditor_report_model->getPurchaseOrderReportBy($date_start, $date_end, $code_start ,$code_end, $supplier_id, $keyword);
