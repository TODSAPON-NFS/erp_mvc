                ...
                <table width="100%" class="table table-bordered table-hover" >
                    <thead>
                        <tr>
                            ...
                            <th colspan="5" style="text-align: center;vertical-align: middle;" >ใบรับสินค้า</th>    
                        ...
                        <tr>
                            ...
                            <th style="text-align: center;vertical-align: middle;" >ใบกำกับภาษี</th>         
                    ...
                    <tbody>
                        ...
                        <tr class="odd gradeX">
                            ...
                            <td><?php echo $creditor_reports[$i]['invoice_supplier_due']; ?></td>
                            <td  align="right" >
                            ...
                            <td  align="right" >
                                <?php echo number_format($creditor_reports[$i]['invoice_supplier_balance'],0); ?>
                            </td>  
                        </tr>
                        <?
