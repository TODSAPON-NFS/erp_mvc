<script>
    function search(){
        ...
        window.location = "index.php?app=report_debtor_02&date_start="+date_start+"&date_end="+date_end+"&customer_id="+customer_id+"&keyword="+keyword;
    }
    function print(type){
        var date_start = $("#date_start").val();
        var date_end = $("#date_end").val();
        ...
        window.open("print.php?app=report_debtor_02&action="+type+"&date_start="+date_start+"&date_end="+date_end+"&customer_id="+customer_id+"&keyword="+keyword,'_blank');
    }
</script>

<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">รายงานใบวางบิล</h1>
    </div>
    <!-- /.col-lg-12 -->
</div>
            ...
            <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <a href="index.php?app=report_debtor_02" class="btn btn-default" style="float:right; margin:0px 4px;">Reset</a>
                    </div>
                </div>
                <br>
                ...
                <table width="100%" class="table table-striped table-bordered table-hover" >
                    <thead>
                        <tr>
                            ...
                            <th>ใบวางบิล <br>Billing Note</th>
                    ...
                    <tbody>
                        ...
                        for($i=0; $i < count($debtor_reports); $i++){
                            $total +=  $debtor_reports[$i]['billing_note_total']; 
                        ?>
                        <tr class="odd gradeX">
                            <td><?php echo $i+1; ?></td>
                            <td><?php echo $debtor_reports[$i]['billing_note_date']; ?></td>
                            <td><?php echo $debtor_reports[$i]['billing_note_code']; ?></td>
                            <td><?php echo $debtor_reports[$i]['customer_code']; ?></td>
                            <td><?php echo $debtor_reports[$i]['billing_note_name']; ?> </td>
                            <td><?php echo $debtor_reports[$i]['employee_name']; ?></td>
                            <td  align="right" >
                                <?php echo number_format($debtor_reports[$i]['billing_note_total'],2); ?>
                            </td> 
                        </tr>
                        <?
                        }
