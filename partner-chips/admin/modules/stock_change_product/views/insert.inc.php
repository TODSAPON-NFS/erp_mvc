...
<div class="row">
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            เพิ่มใบย้ายคลังสินค้า /  Add Stock Change Product   
            </div>
            <!-- /.panel-heading -->
            <div class="panel-body">
            <form id="form_target" role="form" method="post" onsubmit="return check();" action="index.php?app=stock_change_product&action=add" enctype="multipart/form-data">
                <div class="row"> 
                    <div class="col-lg-12">
                        <div class="row">
                            <div class="col-lg-6">
                    ...
                    <table name="tb_list" width="100%" class="table table-striped table-bordered table-hover" >
                        ...
                        <tbody>
                            ...
                            <tr class="odd gradeX">
                                ...
                                <td align="right"><input type="text" class="form-control" style="text-align: right;"  name="stock_change_product_list_price[]" value="<?php echo number_format($stock_change_product_lists[$i]['stock_change_product_list_price'],2); ?>" /></td>
                                <td align="right"><input type="text" class="form-control" style="text-align: right;"  name="stock_change_product_list_total[]" value="<?php echo number_format($stock_change_product_lists[$i]['stock_change_product_list_total'],2); ?>" /></td>
