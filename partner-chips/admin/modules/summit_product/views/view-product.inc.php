...
function getProductDetail(id){
    var product_code = $(id).val();
        $.post( "controllers/getProductByCode.php", { 'product_code': $.trim(product_code)}, function( data ) {
            if(data != null){
                window.location = "?app=summit_product&action=view-product&product_id="+data.product_id;
            }
        });
/*
                    ...
                    <div class="col-lg-10">
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                    ...
                                    <div class="form-group">
                                        <label>ชื่อสินค้า / Product name  <font color="#F00"><b>*</b></font> </label>
                                        <p id="product_name" class="help-block"><?PHP echo $product ['product_name'];?></p>
                                    </div>
