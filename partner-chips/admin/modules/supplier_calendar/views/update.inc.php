    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form role="form"  id="form_target" method="post" onsubmit="return check();" action="index.php?app=supplier&action=edit" enctype="multipart/form-data" >
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2">
                                <div class="form-group">
                                    ...
                                    <input id="credit_day" name="credit_day" type="text" class="form-control" value="<? echo $Supplier['credit_day']?>">
