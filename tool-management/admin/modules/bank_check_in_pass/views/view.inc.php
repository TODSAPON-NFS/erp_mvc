                    ...
                    <tbody>
                        ...
                        <tr class="odd gradeX">
                            ...
                            <td>
                                ...
                                <form  id="form_target_<?PHP echo $checks[$i]['check_id']; ?>" role="form" method="post" onsubmit="return check(this,'<?PHP echo $checks[$i]['check_date_deposit']; ?>');" action="?app=bank_check_in_pass&action=pass&id=<?php echo $checks[$i]['check_id'];?>" enctype="multipart/form-data">
                                    <table width="100%">
                                        <tr>
                                            <td>
                                            ...
                                            <td>
                                                <button type="button" onclick="check_login('form_target_<?PHP echo $checks[$i]['check_id']; ?>');" class="btn btn-success" ><i class="fa fa-check" aria-hidden="true"></i> ผ่านเช็ค</button>
                                            </td>
                                        </tr>
                                    </table>
                                </form>
                                <?PHP } else { ?>
                                <form  id="form_target_<?PHP echo $checks[$i]['check_id']; ?>" role="form" method="post" action="?app=bank_check_in_pass&action=unpass&id=<?php echo $checks[$i]['check_id'];?>" enctype="multipart/form-data"> 
                                    <table width="100%">
                                        <tr>
                                            ...
                                            <td style="padding:0px 4px;" > 
                                                <button type="button" onclick="check_login('form_target_<?PHP echo $checks[$i]['check_id']; ?>');" class="btn btn-danger" ><i class="fa fa-times" aria-hidden="true"></i> ยกเลิก</button>
                                            </td>
                                        </tr>
                                    </table> 
                                </form>
