<script>
    function search(){
        ...
        window.location = "index.php?app=credit_note&date_start="+date_start+"&date_end="+date_end+"&customer_id="+customer_id+"&keyword="+keyword;
    }
</script>
<div class="row">
    <div class="col-lg-6">
            ...
            <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <a href="index.php?app=credit_note" class="btn btn-default" style="float:right; margin:0px 4px;">Reset</a>
                    </div>
                </div>
                <br>
