...
<div class="row">
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            เพิ่มซื้อเงินเชื่อ / Add Credit Purchasing 
            </div>
            <!-- /.panel-heading -->
            <div class="panel-body">
                <form role="form" method="post" onsubmit="return check();" action="index.php?app=credit_purchasing&action=add" >
                                ...
                                <div class="col-lg-8">
                                    <div class="form-group">
                                        ...
                                        <select id="supplier_id" name="supplier_id" class="form-control select" onchange="get_supplier_detail()" data-live-search="true">
                                            ...
                                            ?>
                                            <option <?php if($suppliers[$i]['supplier_id'] == $credit_purchasing['supplier_id']){?> selected <?php }?> value="<?php echo $suppliers[$i]['supplier_id'] ?>"><?php echo $suppliers[$i]['supplier_name_en'] ?>  </option>
                                            <?
                                            }
                                            ?>
                                        </select>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="credit_purchasing_date" name="credit_purchasing_date" value="<?PHP echo $first_date;?>"  class="form-control calendar" readonly/>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input id="credit_purchasing_code" name="credit_purchasing_code" class="form-control" value="<?PHP echo $last_code;?>" readonly>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input id="credit_purchasing_delivery_by" name="credit_purchasing_delivery_by" class="form-control" value="" />
