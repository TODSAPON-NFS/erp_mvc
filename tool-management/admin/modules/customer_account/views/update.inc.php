...
<div class="row">
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <!-- /.panel-heading -->
            <div class="panel-body">
                <form role="form" id="form_target" method="post" onsubmit="return check();" action="index.php?app=customer_account&action=edit&id=<?php echo $customer_id?>" enctype="multipart/form-data">
                    <input type="hidden" id="customer_account_id" name="customer_account_id" value="<?php echo $customer_account_id?>"/>
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label>Account No<font color="#F00"><b>*</b></font></label>
                                <input id="customer_account_no" name="customer_account_no"  class="form-control" value="<? echo $customer_account['customer_account_no'];?>">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input id="customer_account_name" name="customer_account_name" class="form-control" value="<? echo $customer_account['customer_account_name'];?>">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input id="customer_account_bank" name="customer_account_bank" class="form-control" value="<? echo $customer_account['customer_account_bank'];?>">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input id="customer_account_branch" name="customer_account_branch" class="form-control" value="<? echo $customer_account['customer_account_branch'];?>">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label>Detail </label>
                                <input id="customer_account_detail" name="customer_account_detail" class="form-control" value="<? echo $customer_account['customer_account_detail'];?>">
