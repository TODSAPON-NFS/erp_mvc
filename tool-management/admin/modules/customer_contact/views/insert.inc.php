...
<div class="row">
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <!-- /.panel-heading -->
            <div class="panel-body">
                <form  id="form_target" role="form" method="post" onsubmit="return check();" action="index.php?app=customer_contact&action=add&id=<?php echo $customer_id?>" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label>Name<font color="#F00"><b>*</b></font></label>
                                <input id="customer_contact_name" name="customer_contact_name"  class="form-control">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input id="customer_contact_position" name="customer_contact_position" class="form-control">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label>Telephone </label>
                                <input id="customer_contact_tel" name="customer_contact_tel" class="form-control" >
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label>Email</label>
                                <input id="customer_contact_email" name="customer_contact_email"  class="form-control">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label>Detail </label>
                                <input id="customer_contact_detail" name="customer_contact_detail" class="form-control">
