<script>
    ...
    function get_customer_detail(){
        ...
        $.post( "controllers/getCustomerByID.php", { 'customer_id': customer_id }, function( data ) {
            ...
            document.getElementById('invoice_customer_vat').value = data.vat ;
...
<div class="row">
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            เพิ่มใบกำกับภาษีลูกหนี้ยกยอดมา / Add Invoice Customer Begin 
            </div>
            <!-- /.panel-heading -->
            <div class="panel-body">
                <form id="form_target" role="form" method="post" onsubmit="return check();" action="index.php?app=summit_dedit&action=add" >
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="row">
                                <div class="col-lg-6">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="invoice_customer_date" name="invoice_customer_date" value="<?PHP echo $first_date;?>" onchange="generate_credit_date();" class="form-control calendar" readonly/>
                    ...
                    <table width="100%" class="table table-striped table-bordered table-hover" >
                        ...
                        <tfoot>
                            <tr class="odd gradeX">
                                ...
                                <td width="200px" >
                                    <input type="text" class="form-control" style="text-align: right;" id="invoice_customer_total_price" name="invoice_customer_total_price" onchange="calculateAll()" value=""  />
                                </td>
                            </tr>
                            <tr class="odd gradeX">
                                <td width="300px" align="left" style="vertical-align: middle;">
                                ...
                                <td width="200px">
                                    <input type="text" class="form-control" style="text-align: right;" id="invoice_customer_vat_price"  name="invoice_customer_vat_price" value=""  readonly/>
                                </td>
                            </tr>
                            <tr class="odd gradeX">
                                <td width="300px" align="left" style="vertical-align: middle;">
                                ...
                                <td width="200px">
                                    <input type="text" class="form-control" style="text-align: right;" id="invoice_customer_net_price" name="invoice_customer_net_price" value="" readonly/>
                                </td>
                            </tr>
                        </tfoot>
                    </table>   
