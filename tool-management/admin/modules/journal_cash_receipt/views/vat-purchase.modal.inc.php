    ...
    $.post( "controllers/getInvoiceSupplierByID.php", { 'invoice_supplier_id': invoice_supplier_id }, function( data ) { 
        ...
        if(data !== null){
            ...
            if(row_journal_id == null){
                ...
                $('#invoice_supplier_description').val($(row_journal_id).closest('tr').children('td').children('input[name="journal_cash_receipt_list_name[]"]').val())
            }
            ...
            $('#invoice_supplier_date').val($('#journal_cash_receipt_date').val()); 
            $('#invoice_supplier_code_gen').val($('#journal_cash_receipt_code').val()); 
            $('#invoice_supplier_date_recieve').val($('#journal_cash_receipt_date').val()); 
            $('#supplier_code').val(''); 
            ...
            if(row_journal_id == null){
                $('#invoice_supplier_description').val($('#journal_cash_receipt_name').val());
            }else{
                $('#invoice_supplier_description').val($(row_journal_id).closest('tr').children('td').children('input[name="journal_cash_receipt_list_name[]"]').val())
            }  
            ...
            if(row_journal_id == null){
                ...
                $('#tb_journal').children('tbody').append(
                    '<tr class="odd gradeX">'+
                        ...
                        '</td>'+
                        '<td><input type="text" class="form-control" name="journal_cash_receipt_list_name[]" value="' + data.invoice_supplier_description + '" /></td>'+
                        '<td align="right"><input type="text" class="form-control" style="text-align: right;" onclick="edit_credit(this);"  onchange="val_format(this);" name="journal_cash_receipt_list_debit[]" value="'+ invoice_supplier_vat_price_debit.toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") +'"  readonly/></td>'+
                        '<td align="right"><input type="text" class="form-control" style="text-align: right;" onclick="edit_credit(this);"  onchange="val_format(this);" name="journal_cash_receipt_list_credit[]" value="'+ invoice_supplier_vat_price_credit.toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") +'" readonly/></td>'+
                        '<td>'+
                ...
                //$(row_journal_id).closest('tr').children('td').children('input[name="journal_cash_receipt_list_name[]"]').val(data.invoice_supplier_description);
                $(row_journal_id).closest('tr').children('td').children('input[name="journal_cash_receipt_list_debit[]"]').val(invoice_supplier_vat_price_debit.toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,"));
                $(row_journal_id).closest('tr').children('td').children('input[name="journal_cash_receipt_list_credit[]"]').val(invoice_supplier_vat_price_credit.toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,"));
                $('.select').selectpicker();
            }
