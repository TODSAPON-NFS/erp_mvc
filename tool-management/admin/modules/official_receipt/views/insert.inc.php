    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form id="form_target" role="form" method="post" onsubmit="return check();" action="index.php?app=official_receipt&action=add" >
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="row">
                                <div class="col-lg-6">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input  id="official_receipt_name" name="official_receipt_name" class="form-control" value="<?php echo $customer['customer_name_en'];?>  " >
