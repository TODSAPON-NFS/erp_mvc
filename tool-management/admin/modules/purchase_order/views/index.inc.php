    ...
    if(isset($purchase_order_id)){
        ...
        if($supplier_id > 0){
            ...
            $body = '
                ...
                At <a href="http://arno-thailand.revelsoft.co.th/tool-management/supplier/index.php?app=purchase_order&action=checking&id='.$purchase_order_id.'">Click</a> 
            ...
            $mail->Subject = "Tool management order recheck to ".$supplier['supplier_name_en'];
    ...
    if(isset($purchase_order_id)){
        ...
        if($supplier_id > 0){
            ...
            $body = '
                ...
                At <a href="http://arno-thailand.revelsoft.co.th/tool-management/supplier/index.php?app=purchase_order&action=sending&id='.$purchase_order_id.'">Click</a> 
            ...
            $mail->SetFrom("support@revelsoft.co.th", "Revelsoft.co.th");
            $mail->AddReplyTo("support@revelsoft.co.th","Revelsoft.co.th");
            $mail->Subject = "Tool management order confirm to ".$supplier['supplier_name_en'];
