<script>
    function search(){
        ...
        window.location = "index.php?app=report_debtor_01&date_start="+date_start+"&date_end="+date_end+"&customer_id="+customer_id+"&keyword="+keyword;
    }
    function print(type){
        var date_start = $("#date_start").val();
        var date_end = $("#date_end").val();
        ...
        window.open("print.php?app=report_debtor_01&action="+type+"&date_start="+date_start+"&date_end="+date_end+"&customer_id="+customer_id+"&keyword="+keyword,'_blank');
    }
</script>
            ...
            <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <a href="index.php?app=report_debtor_01" class="btn btn-default" style="float:right; margin:0px 4px;">Reset</a>
                    </div>
                </div>
                <br>
                ...
                <table width="100%" class="table table-striped table-bordered table-hover" >
                    ...
                    <tbody>
                        ...
                        for($i=0; $i < count($debtor_reports); $i++){
                            $total +=  $debtor_reports[$i]['invoice_customer_total_price'];
                        ...
                        <tr class="odd gradeX">
                            ...
                            <td><?php echo $debtor_reports[$i]['invoice_customer_name']; ?> </td>
                            <td><?php echo $debtor_reports[$i]['employee_name']; ?></td>
                            <td  align="right" >
                                <?php echo number_format($debtor_reports[$i]['invoice_customer_total_price'],2); ?>
                            </td>
                            <td  align="right" >
                                <?php echo number_format($debtor_reports[$i]['invoice_customer_vat_price'],2); ?>
                            </td> 
                            <td  align="right" >
