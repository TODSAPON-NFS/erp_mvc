        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form role="form" method="post" onsubmit="return check();" action="index.php?app=request_regrind&action=approve&id=<?php echo $request_regrind_id;?>" >
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <p class="help-block"><?php   echo $request_regrind['customer_name_en'];?> </p>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label>ผู้ขาย / Supplier </label>
                                <p class="help-block"><?php  echo $request_regrind['supplier_name_en'];?> </p>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <?php if(($license_request_page == "High" || $license_manager_page == "High" ) && $request_regrind['request_regrind_cancelled'] == 0 ){ ?>
