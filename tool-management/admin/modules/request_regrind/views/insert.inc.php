...
<div class="row">
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            เพิ่มใบร้องขอสั่งซื้อสินค้าทดลองรีกายด์ /  Add Regrind Tool Request   
            </div>
            <!-- /.panel-heading -->
            <div class="panel-body">
                <form id="form_target" role="form" method="post" onsubmit="return check();" action="index.php?app=request_regrind&action=add" >
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label>ประเภทใบร้องขอสั่งซื้อสินค้าทดลองรีกายด์ / RPTR Code <font color="#F00"><b>*</b></font></label>
                                <input id="request_regrind_code" name="request_regrind_code" class="form-control" value="<?php echo $last_code;?>" readonly>
                    ...
                    <div class="row"> 
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <input id="request_regrind_remark" name="request_regrind_remark" class="form-control" />
