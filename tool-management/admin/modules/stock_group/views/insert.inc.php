    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form id="form_target" role="form" method="post" onsubmit="return check();" action="index.php?app=stock_group&stock_type_id=<?php echo $stock_type_id;?>&action=add" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-lg-4">
