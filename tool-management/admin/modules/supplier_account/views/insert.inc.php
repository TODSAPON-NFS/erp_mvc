...
<div class="row">
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <!-- /.panel-heading -->
            <div class="panel-body">
                <form  id="form_target" role="form" method="post" onsubmit="return check();" action="index.php?app=supplier_account&action=add&id=<?php echo $supplier_id?>" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label>Account No<font color="#F00"><b>*</b></font></label>
                                <input id="supplier_account_no" name="supplier_account_no"  class="form-control">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input id="supplier_account_name" name="supplier_account_name" class="form-control">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input id="supplier_account_bank" name="supplier_account_bank" class="form-control" >
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input id="supplier_account_branch" name="supplier_account_branch" class="form-control" >
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label>Detail </label>
                                <input id="supplier_account_detail" name="supplier_account_detail" class="form-control">
