...
<div class="row">
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <!-- /.panel-heading -->
            <div class="panel-body">
                <form  id="form_target" role="form" method="post" onsubmit="return check();" action="index.php?app=supplier_contact&action=edit&id=<?php echo $supplier_id?>" enctype="multipart/form-data">
                    <input type="hidden" id="supplier_contact_id" name="supplier_contact_id" value="<?php echo $supplier_contact_id?>"/>
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input id="supplier_contact_name" name="supplier_contact_name" value="<? echo $supplier_contact['supplier_contact_name'];?>"  class="form-control">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input id="supplier_contact_position" name="supplier_contact_position" value="<? echo $supplier_contact['supplier_contact_position'];?>" class="form-control">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label>Telephone </label>
                                <input id="supplier_contact_tel" name="supplier_contact_tel" value="<? echo $supplier_contact['supplier_contact_tel'];?>"  class="form-control" >
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label>Email</label>
                                <input id="supplier_contact_email" name="supplier_contact_email" value="<? echo $supplier_contact['supplier_contact_email'];?>" class="form-control">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label>Detail </label>
                                <input id="supplier_contact_detail" name="supplier_contact_detail" value="<? echo $supplier_contact['supplier_contact_detail'];?>" class="form-control">
